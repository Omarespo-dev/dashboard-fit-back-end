...
* Registrazione pasti, calorie e macronutrienti
* Tracking degli allenamenti e attività giornaliere
* Dashboard settimanale con statistiche
* Architettura modulare (routes, controllers, services)
* Integrazione con Supabase Postgres + Auth
...
* Sicurezza tramite RLS (Row-Level Security)
